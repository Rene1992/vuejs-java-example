...
time, while keeping it available to screen reader customers as an `aria-live` region.
...
within the calendar for screen reader customers. e.g. the `label-selected` prop is added to the element
