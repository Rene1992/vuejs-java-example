...
This will inform customers of assistive technologies that the checkboxes are related and enables native
...
only customers) to know which checkboxes belong to the same form variable (the name also automatically
...
Not all screen readers will convey the indeterminate state to screen reader customers. So it is
