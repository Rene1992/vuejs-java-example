...
making headers more accessible for customers of assistive technologies.
...
provide customers of assistive technologies (i.e. sight-impaired customers) additional context about the
dropdown item:
...
components, but customers can still use <kbd>Tab</kbd> or <kbd>Shift</kbd>+<kbd>Tab</kbd> to move into
