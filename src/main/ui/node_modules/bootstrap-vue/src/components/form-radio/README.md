...
only customers) to know which radios belong to the same form variable (the name also automatically
...
### Conveying contextual validation state to assistive technologies and colorblind customers

Using these contextual states to denote the state of a form control only provides a visual,
color-based indication, which will not be conveyed to customers of assistive technologies - such as
screen readers - or to colorblind customers.
