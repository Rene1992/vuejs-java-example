...
within the sidebar. Note that in rare circumstances it might be possible for customers to move focus to
...
reader and keyboard-only customers. When the sidebar is closed, the element that previously had focus
before the sidebar was opened will be re-focused.

When the sidebar is open, customers can press <kbd>Esc</kbd> to close the sidebar. To disable this
