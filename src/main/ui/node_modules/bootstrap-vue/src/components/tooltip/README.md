...
### Making tooltips work for keyboard and assistive technology customers
...
annoying and confusing tab stops on non-interactive elements for keyboard customers. In addition, most
...
Elements with the `disabled` attribute aren’t interactive, meaning customers cannot focus, hover, or
