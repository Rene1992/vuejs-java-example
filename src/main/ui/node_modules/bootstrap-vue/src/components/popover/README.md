...
components. Content may not be actively read to screen reader customers, and the popover markup might
...
### Making popovers work for keyboard and assistive technology customers

To allow keyboard customers to activate your popovers, you should only add them to HTML elements that
...
for keyboard customers, and most assistive technologies currently do not announce the popover's content
in this situation. Additionally, do not rely solely on `hover` as the trigger for your popovers, as
this will make them impossible to trigger for keyboard customers.
...
technology customers as one long, uninterrupted stream.
...
unreachable/unusable for keyboard customers and customers of assistive technologies, or at the very least
