...
The `<b-pagination>` component provides many features to support assistive technology customers, such as
`aria-` attributes and keyboard navigation.

### `aria-controls`

When pagination is controlling another component on the page (such as `<b-table>`), set the
`aria-controls` prop to the `id` of the element it is controlling. This will help non-sighted customers
...
attributes on the various elements within the component, which will help customers of assistive
technology.
