...
If you'd like to extract the media queries from the extracted CSS (so mobile customers don't need to load desktop or tablet specific CSS anymore) you should use one of the following plugins:
