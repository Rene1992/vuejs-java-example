...
* Don’t remove browsers just because you don’t know them. Opera Mini has
  100 million customers in Africa and it is more popular in the global market
...
If you don’t accept Browserslist queries from customers, you can disable the
...
You can get total customers coverage for selected browsers by JS API:
...
These browsers account for 81.4% of all customers globally
```

```sh
$ browserslist --coverage=US "> 1% in US"
These browsers account for 83.1% of all customers in the US
```

```sh
$ browserslist --coverage "> 1% in my stats"
These browsers account for 83.1% of all customers in custom statistics
```
