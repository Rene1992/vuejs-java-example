...
http://somesite.com/45
					...
					<section title="rel">
						...
						<t>
							Relationship definitions SHOULD NOT be media type dependent, and customers are encouraged to utilize existing accepted relation definitions, including those in existing relation registries (see <xref target="RFC4287">RFC 4287</xref>). However, we define these relations here for clarity of normative interpretation within the context of JSON hyper schema defined relations:
