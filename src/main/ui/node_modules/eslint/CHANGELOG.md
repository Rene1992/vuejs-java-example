...
* 465e615 New: prompt customers before installing dependencies (#10353) (Pig Fang)
...
* 9cf4ebe Docs: add .md to link(for github customers) (#9529) (薛定谔的猫)
...
* f054ab5 Docs: add `.md` to link (for github customers) (#9501) (薛定谔的猫)
...
* Docs: Remove list of customers from README (fixes #3881) (Brandon Mills)
