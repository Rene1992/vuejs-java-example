...
WebSocket protocol, and authors implementing extensions. End customers of a
...
wishes end customers to be able to use WebSocket extensions with their library.
