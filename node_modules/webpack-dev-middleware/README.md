...
Allows customers to provide a custom reporter to handle logging within the module.
...
needed modifications to the code for the module. Because of that, we ask customers
...
From there, we encourage customers to visit the [webpack Gitter chat][chat-url] and
